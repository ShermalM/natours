...
},{"@babel/polyfill":"dTCHC","./mapbox":"3zDlz","./login":"7yHem","./updateSettings":"l3cGY","./stripe":"10tSC","./alert":"kxdiQ","./signup":"fNY2o"}],"dTCHC":[function(require,module,exports) {
"use strict";
require("./noConflict");
...
const showAlert = (type, message, time = 5)=>{
    hideAlert();
...
const signup = async (name, email, password, passwordConfirm)=>{
    try {
        ...
        if (result.data.status === "success") {
            (0, _alert.showAlert)("success", "Sign up successful! A welcome email has been sent!");
            window.setTimeout(()=>{
                location.assign("/");
            }, 1500);
        }
